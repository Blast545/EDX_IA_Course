...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        # The initial state is the initial position and a boolean for each corner
        booleanCorners = []
        for corner in self.corners:
            booleanCorners.append((self.startingPosition == corner))
            
        booleanCornersTuple = (booleanCorners[0], booleanCorners[1], 
                               booleanCorners[2], booleanCorners[3])

        self.startState = (self.startingPosition, booleanCornersTuple)
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                for i in range(len(self.corners)):    
                    ...
                    #print 'this'
                    #print (nextPosition == corner)
                    #print (state[1][i])
                    cornerBoolean = ((nextPosition == corner) or (state[1][i]))
                    #print cornerBoolean
                    #print 'this' 
                    booleanCorners.append(cornerBoolean)
                
                booleanCornersTuple = (booleanCorners[0], booleanCorners[1], 
                                       booleanCorners[2], booleanCorners[3])

                nextState = (nextPosition, booleanCornersTuple)
